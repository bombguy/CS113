...
public class skill3_button : MonoBehaviour {
    Button skillButton;
    Image skillImage;
    Text skillName;
    ...
    void updateSkill() {
        if (BattleManager.selectedUnit == null)
        {
            ...
            if (current_skill == null)
                addSkilltoButton(BattleManager.selectedUnit.skill3);
            else if (current_skill != BattleManager.selectedUnit.skill3)
                addSkilltoButton(BattleManager.selectedUnit.skill3);
        }
    }
